...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 has-focus-visible:border-0 has-focus-visible:ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent",
        className
      )}
      {...props}
    />
