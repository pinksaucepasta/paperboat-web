...
export function SidebarMenuSkeleton({
  ...
  // Varied width between 50% and 90%, so a stack of skeletons doesn't read as
  // a uniform block. Derived from the instance id rather than Math.random():
  // random during render is impure, gives a different value on every re-render,
  // and mismatches between the server and client HTML.
